#
# This comes from https://github.com/Nepherhotep/unwrap_labels
# I've modified it slightly so the robot can invoke it on a file passed to it
#
# we are using it to pull out the label on the bottle for better reading
# those in this challenge it needed read were called _unwrapped.jpg
#
import cv2
import numpy as np
import os
